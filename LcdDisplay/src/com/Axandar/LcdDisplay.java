...
* @author Andrew Chandler edited by Axandar
*/
...
* @throws Exception
*/
	public void I2CLcdDisplay(int rows, int columns, int i2cBus, int i2cAddress, int backlightBit, int rsBit, int rwBit,
		...
		this.rows = rows;
		this.columns = columns;
		I2CBus bus = I2CBusImplBananaPi.getBus(i2cBus);//changed to use Bananapi I2C
